...
const Results = () => {
  ...
  const deselectAllRows = () => {
    ...
    return (
      ...
      <div className="ml-auto mx-12 right-0 w-[65%] rounded-xl mt-8 mb-2">
    <div>
      ...
      />
            ...
            <div className="flex gap-4">
              <div>
                  ...
                  <input type="radio" onClick={selectAllRows} style={{ marginRight: "10px" }} name='select'/>
              
                <label >Select All</label>
              </div>
              <div>
             <input type="radio" name="select" onClick={deselectAllRows} style={{ marginRight: "10px" }} />
